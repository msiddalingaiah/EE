...
class ClockFrame(ttk.Frame):
    def __init__(self, container):
        super().__init__(container)
        ttk.Button(self, text='Start').grid(column=0, row=0, padx=5, pady=2)
        ttk.Button(self, text='Stop').grid(column=0, row=1, padx=5, pady=2)
        ttk.Button(self, text='Step').grid(column=0, row=2, padx=5, pady=2)
        ttk.Button(self, text='Step #').grid(column=0, row=3, padx=5, pady=2)
        nClocks = ttk.Entry(self, width=5)
        nClocks.focus()
        nClocks.grid(column=1, row=3, sticky=tk.W)
